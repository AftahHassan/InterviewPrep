                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('domains.concepts.update', [$domain, $concept]) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="explanation" name="explanation" rows="6" class="mt-1 block w-full border-slate-600 bg-slate-700 text-white placeholder-slate-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('explanation', $concept->explanation) }}</textarea>
