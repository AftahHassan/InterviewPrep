                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('domains.concepts.store', $domain) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="explanation" name="explanation" rows="6" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('explanation') }}</textarea>
