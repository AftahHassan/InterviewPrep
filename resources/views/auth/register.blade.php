        ...
        <div class="w-3/5 bg-slate-950 p-16 flex flex-col justify-center relative overflow-hidden">
            ...
            <div class="relative z-10 max-w-xl">
                ...
                <p class="text-lg text-slate-400 max-w-lg">
                    Rejoins la plateforme et commence à structurer ta préparation dès maintenant.
                </p>
                ...
                <div class="mt-10 flex items-center gap-3 text-sm text-slate-500">
                    ...
                    <span>Gratuit. Sans engagement. 30 secondes suffisent.</span>
                </div>
            </div>
        ...
        <div class="w-2/5 bg-white p-16 flex flex-col justify-center items-center">
            <div class="max-w-sm w-full">
                <div class="mb-8">
                    ...
                    <p class="text-slate-500 mt-1">Commence ta préparation en 30 secondes.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name"
                               class="block w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-800 placeholder-slate-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200 @error('name') border-red-400 @enderror"
                               placeholder="Ton nom">
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                               class="block w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-800 placeholder-slate-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                ...
                <p class="mt-6 text-center text-sm text-slate-500">
                    Déjà un compte ?
                    <a href="{{ route('login') }}" class="font-semibold text-indigo-600 hover:text-indigo-500 transition">Se connecter</a>
                </p>
            </div>
        </div>
